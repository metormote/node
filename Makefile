...
# List C source modules here.
MODULES = 
MODULES += config
MODULES += asf/common/boards
MODULES += asf/common/services/cpu
MODULES += asf/common/services/clock
MODULES += asf/common/services/clock/xmega
MODULES += asf/common/services/gpio
MODULES += asf/common/services/hugemem
MODULES += asf/common/services/hugemem/avr8
MODULES += asf/common/services/ioport
MODULES += asf/common/services/ioport/xmega
MODULES += asf/common/services/serial
MODULES += asf/common/services/sleepmgr
MODULES += asf/common/services/sleepmgr/xmega
MODULES += asf/common/services/spi
MODULES += asf/common/services/spi/xmega_spi
MODULES += asf/common/services/twi
MODULES += asf/common/utils
MODULES += asf/common/utils/interrupt
MODULES += asf/common/utils/stdio
MODULES += asf/common/utils/stdio/stdio_serial
MODULES += asf/common/utils/unit_test
MODULES += asf/common/components/memory/data_flash/at45dbx
MODULES += asf/xmega/drivers/ac
MODULES += asf/xmega/drivers/adc
MODULES += asf/xmega/drivers/adc/xmega_aau
MODULES += asf/xmega/drivers/aes
MODULES += asf/xmega/drivers/cpu
MODULES += asf/xmega/drivers/dac
MODULES += asf/xmega/drivers/dma
MODULES += asf/xmega/drivers/nvm
MODULES += asf/xmega/drivers/pmic
MODULES += asf/xmega/drivers/rtc
MODULES += asf/xmega/drivers/sleep
MODULES += asf/xmega/drivers/spi
MODULES += asf/xmega/drivers/tc
MODULES += asf/xmega/drivers/twi
MODULES += asf/xmega/drivers/usart
MODULES += asf/xmega/drivers/wdt
MODULES += asf/xmega/utils
MODULES += asf/xmega/utils/preprocessor
MODULES += atomthreads/kernel
MODULES += atomthreads/ports/avr
MODULES += metormote
MODULES += metormote/ant
MODULES += metormote/ble
MODULES += metormote/pmbus
MODULES += metormote/potentiometer
MODULES += metormote/sif
MODULES += metormote/utils
MODULES += metormote/fw
MODULES += xboot
MODULES += nanopb
...
COMMON_FLAGS += $(patsubst %,-I%,$(SRC_DIR))
...
ALL_CFLAGS = -mmcu=$(MCU) -Isrc $(CFLAGS) $(GENDEPFLAGS) $(DEFINES)
ALL_CXXFLAGS = -mmcu=$(MCU) -Isrc $(CXXFLAGS) $(GENDEPFLAGS) $(DEFINES)
ALL_ASFLAGS = -mmcu=$(MCU) -Isrc -x assembler-with-cpp $(ASFLAGS) $(DEFINES)
